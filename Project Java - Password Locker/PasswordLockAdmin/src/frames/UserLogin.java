...
public class UserLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_LoginImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, 160, 170));
    ...
    private void bt_SignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_SignInActionPerformed
        ...
        if(correctUser && correctPassword){
            try {
                ...
                chosenAccount = c.loadChosenAccount(tb_Username.getText());
                AdminPasswordManager pms = new AdminPasswordManager(chosenAccount);
